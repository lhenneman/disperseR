...
Or you can build the image using the Dockerfile found in this github repository 
...
Make sure to run the container from the location where you want tyou disperseR Rstudio project or R files are saved (or where you want them to be saved), `$(pwd):/home/rstudio/kitematic/` allows to sync the local volume with the container's volume.

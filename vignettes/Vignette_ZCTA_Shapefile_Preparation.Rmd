...
In this vignette, we show how we prepared the ZCTA shape that can be downloaded using the `get_data()` function specifying the `data = "zctashapefile"`. In case you want to use different files you can follow some of these preprocessing steps. 

...
If you, for example, you want to download files for Jan-March 2005, you just have to use the `get_data()` function and set `data = "metfiles"`, `start.year = "2005"`, `start.month = "01"`, `end.year = "2005"`, and `end.month = "03"`. See below.


```{r}
disperseR::get_data(data = "all", start.year = "2005", start.month = "07", end.year="2006", end.month="06")
```
